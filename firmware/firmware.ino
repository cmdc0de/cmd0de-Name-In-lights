...
#define PIXELS 60*11  // Number of pixels in the string
...
void show() {
	delay( (RES / 1000UL) + 1);				// Round up since the delay must be _at_least_ this long (too short might not work, too long not a problem)
}
